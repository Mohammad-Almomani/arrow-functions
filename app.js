...
//  this refers to joe institution from the global window object
// 2. What is "this" when joe.scopeArrow() is invoked?
// this refers to the this of enclosing scope which is a scoop only exists in nested functions
// 3. Explain why "this" is different when an arrow function is used.
// because of the function scoop, in the arrow function, the scoop of this was the enclosing scope
// but in the normal function the scoop will be in the browser, so it can refer to joe institution in line 152